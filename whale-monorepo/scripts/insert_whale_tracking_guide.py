"""Insert the Polymarket Whale Tracking Guide (EN + ZH) into blog_posts via API.

Usage:
    cd whale-poly/whale-monorepo
    python scripts/insert_whale_tracking_guide.py
"""
...
logger = logging.getLogger("insert_whale_tracking_guide")

POSTS_DIR = Path("services/landing/src/content/posts")

EN_FILE = POSTS_DIR / "polymarket-whale-tracking-tools-2026-complete-guide.md"
ZH_FILE = POSTS_DIR / "polymarket-whale-tracking-tools-2026-complete-guide-zh.md"
...
def post_blog_post(meta: dict, slug: str, language: str) -> dict:
    ...
    payload = {
        ...
        "tags": meta.get("tags", []),
        "language": language,
        "group_slug": "polymarket-whale-tracking-tools-2026",
        "status": "published",
    }
...
def main():
    ...
    en_slug = "polymarket-whale-tracking-tools-2026-complete-guide"
    zh_slug = "polymarket-whale-tracking-tools-2026-complete-guide-zh"
