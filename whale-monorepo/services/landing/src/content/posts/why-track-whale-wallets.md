...
| Mechanism | What you gain |
|----------|----------------|
| **Price discovery lead** | You notice repricing early enough to **verify** rules and catalysts. |
| **Asymmetric attention** | You focus on markets where **capital** disagrees with **headlines**. |
| **Behavioral clustering** | Repeated flows suggest **persistent thesis**, not one-off noise—*if* history supports it. |
