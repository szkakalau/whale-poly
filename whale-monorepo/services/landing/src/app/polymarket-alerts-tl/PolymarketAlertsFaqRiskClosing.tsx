...
export function PolymarketAlertsPostPricingFaqAndGuarantee() {
  return (
    <>
      <section
        className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0f1210]/95 p-8 md:p-12 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]"
      ...
      >
        ...
        <div className="relative mt-8 space-y-3">
          {faqEntries.map((item) => (
            <article
              key={item.id}
              className="rounded-2xl border border-white/[0.08] bg-black/40 p-5 md:p-6 transition-colors hover:border-cyan-400/25 hover:bg-black/50"
            >
      ...
      <section
        className="relative overflow-hidden rounded-3xl border border-zinc-300/50 bg-gradient-to-br from-[#f4f1ea] via-[#ebe6dc] to-[#e2ddd3] px-8 py-10 text-zinc-900 shadow-[0_24px_80px_-24px_rgba(0,0,0,0.45)] md:px-12 md:py-12"
...
export function PolymarketAlertsClosingCta() {
  return (
    <section
      className="relative overflow-hidden rounded-3xl border border-lime-400/25 bg-[#080a07] p-10 text-center md:p-14"
