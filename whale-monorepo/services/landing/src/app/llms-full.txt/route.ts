...
export async function GET() {
  ...
  const content = [
    ...
    '  filtering, volume-weighted analysis.',
    ...
    'A: No. Telegram is optional. Browse the Volume-Weighted Analysis page to monitor',
    ...
    '## All Public Pages',
    `- ${BASE_URL}/ — Home`,
    `- ${BASE_URL}/about — About: team, principles, contact`,
    ...
    `- ${BASE_URL}/methodology — Whale identification and scoring methodology`,
