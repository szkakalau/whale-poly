// Proxy blog insertion to whale_engine (Prisma write ops fail in Vercel serverless).
const WHALE_ENGINE = process.env.NEXT_PUBLIC_WHALE_ENGINE_API_BASE_URL || 'https://whale-engine-api.onrender.com';

export async function GET() {
  try {
    const res = await fetch(`${WHALE_ENGINE}/blog/insert`, {
      method: 'POST',
      ...
      body: JSON.stringify({
        ...
        language: 'en',
        group_slug: 'polymarket-volume-weighted-analysis',
        status: 'published',
